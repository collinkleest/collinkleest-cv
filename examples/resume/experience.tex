  ...
  \cventry
    ...
    {Apr. 2021 - Current} % Date(s)
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
        \item {Resolved and completed platform tickets and feature requests.}
        \item {Contributed to making the overall platform more stable and reliable, by reducing cloud dependencies.}
