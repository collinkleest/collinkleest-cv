...
\name{Collin}{Kleest}
\position{Software Engineer{\enskip\cdotp\enskip}Greater Philadelphia Area}
% \address{42-8, Bangbae-ro 15-gil, Seocho-gu, Seoul, 00681, Rep. of KOREA}

\mobile{(+1) 484-854-9485}
\email{collinkleest@gmail.com}
%\dateofbirth{January 1st, 1970}
\homepage{https://www.collinkleest.com}
\github{collinkleest}
\linkedin{collinkleest}
% \gitlab{gitlab-id}
